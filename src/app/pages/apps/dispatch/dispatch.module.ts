...
export class OrderItemDetailModule {
    ...
    constructor(product, storeId) {
        ...
        this.OrdItemType = 2;
        this.StorageStoreId = storeId;
        this.Quantity = product.DispatchedQuantity;
        this.UnitPrice = product.price;
        this.Tax1 = product.tax1;
        this.Tax2 = product.tax2;
        this.Amount = 0;
...
export class DispatchModule {
    ...
    TaxAmount: number = 0
    DispatchStatus: number = 0
    constructor(OrdId, OrderedById, SuppliedById, DispatchById, dispatchTypeId,
        finalarray, dispatchstatus, userId, createby, OrdDetail, ordItemId, OrdDetailid, CompanyId, billId) {
        ...
        this.DispatchedDate = moment().format('YYYY-MM-DD HH:mm:ss');
